        ...
        <form className="flex items-center">
          <div className="relative w-full">
            ...
            <input
              type="text"
              id="simple-search"
              className="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-gray-500 focus:border-gray-500 block w-full pl-10 p-2.5  dark:bg-gray-400 dark:border-gray-600 dark:placeholder-gray-800 dark:white dark:focus:ring-gray-500 dark:focus:border-gray-500"
              placeholder="Search"
              required
              value={query}
